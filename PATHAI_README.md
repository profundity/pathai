...
- **`evidence_training_schema.md`** — draft column format for turning rubric judgments into structured rows (gene, claim, function-in-context, activity type, evidence grade, etc.), the first step toward a gold-standard dataset at training scale. Not yet applied to any case.
